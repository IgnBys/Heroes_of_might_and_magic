...
public enum CreatureStatistic implements CreatureStatisticIf {
    ...
    WIGHT("Wight", 7, 7,20, 18, 5, Range.closed(3, 5), 3,
            ...
            false), //
    VAMPIRE("Vampire", 10, 9,20, 30, 6, Range.closed(5, 8), 4,
            ...
            false), //
    LICH("Lich", 13, 10,20, 30, 6, Range.closed(11, 15), 5,
            ...
            false), //
    BLACK_KNIGHT("Black Knight", 16, 16,20, 120, 7, Range.closed(15, 30), 6,
            ...
            false), //
    BONE_DRAGON("Bone Dragon", 17, 15,20, 150, 9, Range.closed(25, 50), 7,
            ...
            false), //
    SKELETON_WARRIOR("Skeleton Warrior", 6, 6,20, 6, 5, Range.closed(1, 3), 1,
    ...
    ZOMBIE("Zombie", 5, 5,20, 20, 4, Range.closed(2, 3), 2,
            ...
            true), //
    WRAITH("Wraith", 7, 7,20, 18, 5, Range.closed(3, 5), 3,
            "Regenerating ability is really good when fighting weak enemies, especially shooters.\nSpecial: top wight of the stack regenerates all lost damage in the beginning of each round\n",
            true), //
    VAMPIRE_LORD("Vampire Lord", 10, 10,20, 40, 9, Range.closed(5, 8), 4,
            ...
            true), //
    POWER_LICH("Power Lich", 13, 10,20, 40, 7, Range.closed(11, 15), 5,
            "Now they last longer and are able to do more damage! A must for good necropolis army.\nSpecial: death cloud range attack - damages living creatures on adjacent hexes to target.\n",
            true), //
    DREAD_KNIGHT("Dread Knight", 18, 18,20, 120, 9, Range.closed(15, 30), 6,
            ...
            true), //
    GHOST_DRAGON("Ghost Dragon", 19, 17,20, 200, 14, Range.closed(25, 50), 7,
    ...
    CreatureStatistic(final String aName, final int aAttack, final int aArmor, final int aMagicResistance, final int aMaxHp,
